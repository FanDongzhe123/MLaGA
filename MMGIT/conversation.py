        ...
        if self.sep_style == SeparatorStyle.SINGLE:
            ...
            for role, message in messages:
                if message:
                    ...
                    ret += role + ":"
        #use different sep for each role
            ...
            for role, message in messages:
                if message:
                    if type(message) is tuple:
                        message, graphs = message
                        message = "<graph>" * len(graphs) + message
...
conv_llaga_llama_2 = Conversation(
    system="You are a helpful language and multimodal graph assistant. "
           "You are able to understand the graph content and the image content that the user provides, "
           "and assist the user with a variety of tasks using natural language.",
    roles=("USER", "ASSISTANT"),
    version="llama_v2",
    messages=(),
...
conv_llava_llama_3 = Conversation(
    system="You are a helpful language and multimodal assistant. " "You are able to understand the graph content and the visual content that the user provides, " "and assist the user with a variety of tasks using natural language.",
    roles=("user", "assistant"),
    version="llama_v3",
    messages=[],
    offset=0,
...
conv_templates = {
    ...
    "graphllava_llama_2": conv_llaga_llama_2,
    "graphllava_llama_3": conv_llava_llama_3,
    "mpt": conv_mpt,
}
